...
class PublicRecipeAPITests(TestCase):
    """Test unauthenticated API rrequests"""
...
class PrivateRecipeApiTests(TestCase):
    ...
    def test_recipe_list_limited_to_user(self):
        ...
        other_user = create_user(
            email='other@example.com', password='dsds1234')
    ...
    def test_delete_other_users_recipe_error(self):
        """Test trying to delete other user recipe gives an error"""
        new_user = create_user(email='user4@example.com', password='test12345')
    ...
    def test_update_recipe_assign_tag(self):
        """Test assigning an exiting tag when updating a recipe."""
